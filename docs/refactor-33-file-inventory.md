...
| `client/src/core/signingEngine/session/restore/restoreCoordinator.ts` | state owner | Session lifecycle, persistence, available signing lanes, and restore behavior. | 0 |
...
| `client/src/core/signingEngine/session/signingSession/budget.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
| `client/src/core/signingEngine/session/signingSession/budgetFinalizer.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
| `client/src/core/signingEngine/session/signingSession/budgetProjection.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
...
| `client/src/core/signingEngine/session/signingSession/execution.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
| `client/src/core/signingEngine/session/signingSession/lanes.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 1 |
| `client/src/core/signingEngine/session/signingSession/operationFingerprint.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
| `client/src/core/signingEngine/session/signingSession/operationIdBinding.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
| `client/src/core/signingEngine/session/signingSession/planner.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
| `client/src/core/signingEngine/session/signingSession/postSignPolicy.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 1 |
| `client/src/core/signingEngine/session/signingSession/preparedOperation.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
...
| `client/src/core/signingEngine/session/signingSession/trace.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
| `client/src/core/signingEngine/session/signingSession/transactionState.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 0 |
| `client/src/core/signingEngine/session/signingSession/types.ts` | state owner | Current signing-session planner, transaction state, budget, readiness, execution, and trace types. | 1 |
...
| `client/src/core/signingEngine/session/warmSigning/capabilityReader.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 0 |
| `client/src/core/signingEngine/session/warmSigning/capabilityReaderCore.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 2 |
| `client/src/core/signingEngine/session/warmSigning/ecdsaBootstrapRequest.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 0 |
| `client/src/core/signingEngine/session/warmSigning/ecdsaProvisioner.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 2 |
| `client/src/core/signingEngine/session/warmSigning/ed25519Provisioner.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 0 |
| `client/src/core/signingEngine/session/warmSigning/persistence.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 2 |
| `client/src/core/signingEngine/session/warmSigning/postSignPolicyAdapter.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 1 |
| `client/src/core/signingEngine/session/warmSigning/readModel.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 1 |
| `client/src/core/signingEngine/session/warmSigning/runtime.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 1 |
| `client/src/core/signingEngine/session/warmSigning/statusReader.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 1 |
| `client/src/core/signingEngine/session/warmSigning/store.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 1 |
| `client/src/core/signingEngine/session/warmSigning/transitions.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 0 |
| `client/src/core/signingEngine/session/warmSigning/types.ts` | state owner | Warm signing read model, provisioning, persistence, status, and transitions. | 5 |
...
| --- | --- |
| `client/src/core/signingEngine/SigningEngine.ts` | `./api/userPreferences`<br>`./orchestration/thresholdActivation`<br>`./emailOtp/authLane`<br>`./touchConfirm/types`<br>`./touchConfirm/shared/confirmTypes`<br>`./session/signingSession/types`<br>`./session/signingSession/budget`<br>`./signers/webauthn/prompt/touchIdPrompt`<br>`./signers/webauthn/credentials`<br>`./chainAdaptors/evm/types`<br>`./chainAdaptors/evm/evmAdapter`<br>`./chainAdaptors/tempo/types`<br>`./chainAdaptors/tempo/tempoAdapter`<br>`./signers/webauthn/credentials/credentialExtensions`<br>`./api/thresholdLifecycle/thresholdSessionActivation`<br>`./api/thresholdLifecycle/thresholdEd25519Lifecycle`<br>`./api/thresholdLifecycle/thresholdEcdsaBootstrapPersistence`<br>`./session/persistence/records`<br>`./session/signingSession/ecdsaChainTarget`<br>`./api/thresholdLifecycle/thresholdEcdsaLoginPrefill`<br>`./threshold/session/sessionPolicy`<br>`./api/nearSigning`<br>`./api/tempoSigning`<br>`./api/evmFamily/types`<br>`./api/session/signingSessionState`<br>`./api/thresholdLifecycle/thresholdEcdsaCommitQueue`<br>`./api/thresholdLifecycle/thresholdEd25519CommitQueue`<br>`./api/recovery/privateKeyExportRecovery`<br>`./signers/webauthn/device/signerSlot`<br>`./touchConfirm/ui/export-viewer-host`<br>`./api/registration/registrationSession`<br>`./api/registration/registrationAccountLifecycle`<br>`./signers/wasm/hssClientSignerWasm`<br>`./orchestration/near/shared/ensureThresholdEd25519HssClientBase`<br>`./emailOtp/EmailOtpThresholdSessionCoordinator`<br>`./session/signingSession/trace`<br>`./session/availability/readiness`<br>`./orchestration/thresholdActivation`<br>`./emailOtp/EmailOtpThresholdSessionCoordinator`<br>`./api/nearSigning`<br>`./api/thresholdLifecycle/thresholdEcdsaLoginPrefill` |
| `client/src/core/signingEngine/api/evmFamily/authPlanning.ts` | `@/core/signingEngine/touchConfirm/shared/confirmTypes`<br>`../../emailOtp/authLane`<br>`../../session/availability/readiness`<br>`../../session/signingSession/trace`<br>`../../session/signingSession/types`<br>`../../session/signingSession/types`<br>`../../session/signingSession/preparedOperation`<br>`../../orchestration/shared/touchConfirmSigning`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/evmFamily/budgetSpending.ts` | `../../session/signingSession/budgetFinalizer`<br>`../../session/signingSession/budget`<br>`../../session/signingSession/types`<br>`../../session/signingSession/transactionState` |
| `client/src/core/signingEngine/api/evmFamily/ecdsaLanes.ts` | `../../session/signingSession/lanes`<br>`../../emailOtp/authLane`<br>`../../session/signingSession/lanes`<br>`../../session/signingSession/types`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/evmFamily/ecdsaReadiness.ts` | `../../session/signingSession/types`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/evmFamily/ecdsaSelection.ts` | `../../session/signingSession/types`<br>`../../session/signingSession/trace`<br>`../../session/signingSession/transactionState`<br>`../../session/signingSession/transactionState`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/evmFamily/emailOtpRefresh.ts` | `../../session/signingSession/types`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/evmFamily/events.ts` | `../../session/signingSession/execution`<br>`../../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/api/evmFamily/nonceMetrics.ts` | `../../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/api/evmFamily/operationIds.ts` | `../../session/signingSession/types`<br>`../../session/signingSession/operationIdBinding` |
| `client/src/core/signingEngine/api/evmFamily/postSignPolicy.ts` | `../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/evmFamily/preparedSigning.ts` | `../../session/signingSession/budget`<br>`../../session/signingSession/transactionState`<br>`../../session/signingSession/ecdsaChainTarget`<br>`../../session/signingSession/preparedOperation`<br>`../../session/signingSession/trace` |
...
| `client/src/core/signingEngine/api/evmFamily/signingFlowRuntime.ts` | `../../orchestration/shared/thresholdSigningSessionReadiness`<br>`../../session/signingSession/types`<br>`../../session/signingSession/execution`<br>`../../session/signingSession/trace`<br>`../../chainAdaptors/evm/types`<br>`../../chainAdaptors/tempo/types`<br>`../../signers/webauthn/credentials/credentialExtensions`<br>`../../threshold/session/sessionPolicy`<br>`../../orchestration/shared/thresholdEcdsaTransactionAdmission`<br>`../../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/api/evmFamily/transactionExecutor.ts` | `../../session/signingSession/types`<br>`../../session/signingSession/execution`<br>`../../chainAdaptors/evm/evmAdapter`<br>`../../chainAdaptors/evm/types`<br>`../../chainAdaptors/tempo/tempoAdapter`<br>`../../chainAdaptors/tempo/types`<br>`../../session/signingSession/budget`<br>`../../session/signingSession/transactionState`<br>`../../session/signingSession/ecdsaChainTarget`<br>`../../orchestration/shared/thresholdEcdsaTransactionAdmission` |
| `client/src/core/signingEngine/api/evmFamily/types.ts` | `../../chainAdaptors/evm/evmAdapter`<br>`../../chainAdaptors/evm/types`<br>`../../chainAdaptors/tempo/tempoAdapter`<br>`../../chainAdaptors/tempo/types`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/evmFamily/warmSessionServices.ts` | `../../orchestration/thresholdActivation`<br>`../../orchestration/walletOrigin/thresholdEcdsaCoordinator`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/evmSigning.ts` | `../chainAdaptors/evm/types`<br>`../chainAdaptors/evm/evmAdapter`<br>`../chainAdaptors/tempo/types`<br>`../chainAdaptors/tempo/tempoAdapter`<br>`../session/signingSession/types`<br>`../session/signingSession/trace`<br>`../session/signingSession/operationFingerprint`<br>`../session/signingSession/budget`<br>`../orchestration/thresholdActivation`<br>`../emailOtp/authLane`<br>`../session/signingSession/ecdsaChainTarget`<br>`../touchConfirm/shared/confirmTypes`<br>`../session/signingSession/transactionState` |
| `client/src/core/signingEngine/api/nearSigning.ts` | `../emailOtp/authLane`<br>`@/core/signingEngine/touchConfirm/shared/confirmTypes`<br>`../orchestration/near/nearSigningFlow`<br>`../threshold/session/sessionPolicy`<br>`../session/signingSession/types`<br>`../session/signingSession/lanes`<br>`../session/signingSession/ecdsaChainTarget`<br>`../session/signingSession/budget`<br>`../orchestration/shared/touchConfirmSigning`<br>`../session/signingSession/trace`<br>`../session/signingSession/preparedOperation`<br>`../session/signingSession/transactionState` |
| `client/src/core/signingEngine/api/recovery/privateKeyExportRecovery.ts` | `../../signers/webauthn/device/signerSlot`<br>`../../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/api/tempoSigning.ts` | `../chainAdaptors/evm/types`<br>`../chainAdaptors/evm/evmAdapter`<br>`../chainAdaptors/tempo/types`<br>`../chainAdaptors/tempo/tempoAdapter`<br>`../session/signingSession/types`<br>`../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/thresholdLifecycle/thresholdEcdsaBootstrapPersistence.ts` | `../../orchestration/thresholdActivation`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/thresholdLifecycle/thresholdEcdsaCommitQueue.ts` | `../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/api/thresholdLifecycle/thresholdEcdsaLoginPrefill.ts` | `../../orchestration/walletOrigin/thresholdEcdsaCoordinator`<br>`../../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/api/thresholdLifecycle/thresholdSessionActivation.ts` | `../../signers/webauthn/prompt/touchIdPrompt`<br>`../../orchestration/thresholdActivation`<br>`../../threshold/session/sessionPolicy`<br>`../../session/signingSession/types`<br>`../../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/assembly/createPorts.ts` | `../touchConfirm/types`<br>`../chainAdaptors/evm/types`<br>`../chainAdaptors/evm/evmAdapter`<br>`../chainAdaptors/tempo/types`<br>`../chainAdaptors/tempo/tempoAdapter`<br>`../signers/webauthn/prompt/touchIdPrompt`<br>`../api/nearSigning`<br>`../api/recovery/privateKeyExportRecovery`<br>`../api/registration/registrationAccountLifecycle`<br>`../api/registration/registrationSession`<br>`../api/session/signingSessionState`<br>`../api/tempoSigning`<br>`../api/thresholdLifecycle/thresholdEd25519Lifecycle`<br>`../api/evmFamily/accountAuth`<br>`../session/persistence/records`<br>`../api/thresholdLifecycle/thresholdSessionActivation`<br>`../orchestration/thresholdActivation`<br>`../emailOtp/authLane`<br>`../api/userPreferences`<br>`../touchConfirm/ui/confirm-ui`<br>`../session/signingSession/budget`<br>`../session/signingSession/ecdsaChainTarget`<br>`../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/emailOtp/EmailOtpThresholdSessionCoordinator.ts` | `@/core/signingEngine/signers/webauthn/prompt/touchIdPrompt`<br>`@/core/signingEngine/touchConfirm/types`<br>`@/core/signingEngine/session/persistence/records`<br>`@/core/signingEngine/session/persistence/records`<br>`@/core/signingEngine/orchestration/thresholdActivation`<br>`@/core/signingEngine/session/signingSession/ecdsaChainTarget`<br>`@/core/signingEngine/session/availability/readiness`<br>`@/core/signingEngine/threshold/session/sessionPolicy`<br>`@/core/signingEngine/threshold/session/sessionPolicy`<br>`@/core/signingEngine/touchConfirm/shared/confirmTypes`<br>`@/core/signingEngine/signers/wasm/hssClientSignerWasm`<br>`@/core/signingEngine/api/thresholdLifecycle/thresholdEd25519Lifecycle`<br>`@/core/signingEngine/orchestration/near/shared/ensureThresholdEd25519HssClientBase`<br>`@/core/signingEngine/api/thresholdLifecycle/thresholdEcdsaBootstrapPersistence` |
| `client/src/core/signingEngine/emailOtp/authLane.ts` | `@/core/signingEngine/session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/interfaces/near.ts` | `../touchConfirm/shared/confirmTypes`<br>`../session/signingSession/types`<br>`../session/persistence/records`<br>`../session/signingSession/transactionState` |
| `client/src/core/signingEngine/interfaces/runtime.ts` | `../signers/webauthn/prompt/touchIdPrompt`<br>`../api/userPreferences` |
| `client/src/core/signingEngine/interfaces/signing.ts` | `../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/nonce/NonceCoordinator.ts` | `../session/signingSession/types`<br>`../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/flows/shared/operationState.ts` | `../../session/signingSession/types` |
| `client/src/core/signingEngine/orchestration/ensureSmartAccountDeployed.ts` | `../chainAdaptors/evm/types`<br>`../chainAdaptors/tempo/types`<br>`../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/orchestration/near/delegateFlow.ts` | `@/core/signingEngine/threshold/session/sessionPolicy`<br>`@/core/signingEngine/touchConfirm/shared/confirmTypes`<br>`../../session/signingSession/planner` |
...
| `client/src/core/signingEngine/orchestration/near/nep413Flow.ts` | `@/core/signingEngine/threshold/session/sessionPolicy`<br>`../../session/signingSession/planner` |
...
| `client/src/core/signingEngine/orchestration/near/shared/thresholdAuthMode.ts` | `@/core/signingEngine/touchConfirm/shared/confirmTypes`<br>`@/core/signingEngine/session/signingSession/lanes`<br>`@/core/signingEngine/session/signingSession/trace`<br>`@/core/signingEngine/session/signingSession/types`<br>`@/core/signingEngine/session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/orchestration/near/transactionsFlow.ts` | `@/core/signingEngine/touchConfirm/shared/confirmTypes`<br>`../../session/persistence/records`<br>`@/core/signingEngine/threshold/session/sessionPolicy`<br>`../../session/signingSession/types`<br>`../../session/signingSession/transactionState`<br>`../../session/signingSession/trace`<br>`../../session/signingSession/budget`<br>`../../session/signingSession/budgetFinalizer`<br>`../../session/signingSession/operationFingerprint` |
| `client/src/core/signingEngine/orchestration/shared/evmFamilySigningFlow.ts` | `@/core/signingEngine/touchConfirm/shared/displayModel`<br>`@/core/signingEngine/touchConfirm/shared/confirmTypes`<br>`@/core/signingEngine/chainAdaptors/evm/bytes`<br>`@/core/signingEngine/signers/webauthn/credentials/helpers`<br>`@/core/signingEngine/touchConfirm/intentDigestPreparationRegistry`<br>`../../session/signingSession/budget`<br>`../../session/signingSession/transactionState`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/orchestration/shared/thresholdEcdsaTransactionAdmission.ts` | `../../session/signingSession/transactionState`<br>`../../touchConfirm/shared/confirmTypes` |
| `client/src/core/signingEngine/orchestration/shared/thresholdSigningSessionReadiness.ts` | `@/core/signingEngine/session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/orchestration/shared/touchConfirmSigning.ts` | `@/core/signingEngine/touchConfirm/shared/confirmTypes`<br>`@/core/signingEngine/session/signingSession/types`<br>`@/core/signingEngine/session/signingSession/types`<br>`@/core/signingEngine/touchConfirm/shared/emailOtpPromptCopy` |
...
| `client/src/core/signingEngine/orchestration/thresholdActivation.ts` | `@/core/signingEngine/threshold/session/sessionPolicy`<br>`@/core/signingEngine/session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/session/signingSession/lanes.ts` | `../../session/persistence/records` |
| `client/src/core/signingEngine/session/signingSession/postSignPolicy.ts` | `../../session/persistence/records` |
| `client/src/core/signingEngine/session/availability/readiness.ts` | `../../session/persistence/records` |
| `client/src/core/signingEngine/session/signingSession/types.ts` | `../../session/persistence/records` |
| `client/src/core/signingEngine/session/availability/availableSigningLanes.ts` | `../threshold/session/sessionPolicy` |
| `client/src/core/signingEngine/session/warmSigning/capabilityReaderCore.ts` | `../../emailOtp/authLane`<br>`../../session/persistence/records` |
| `client/src/core/signingEngine/session/warmSigning/ecdsaProvisioner.ts` | `../../session/persistence/records`<br>`../../orchestration/thresholdActivation` |
| `client/src/core/signingEngine/session/warmSigning/persistence.ts` | `../../session/persistence/records`<br>`../../threshold/session/sessionPolicy` |
| `client/src/core/signingEngine/session/warmSigning/postSignPolicyAdapter.ts` | `../../session/persistence/records` |
| `client/src/core/signingEngine/session/warmSigning/readModel.ts` | `../../session/persistence/records` |
| `client/src/core/signingEngine/session/warmSigning/runtime.ts` | `../../session/persistence/records` |
| `client/src/core/signingEngine/session/warmSigning/statusReader.ts` | `../../session/persistence/records` |
| `client/src/core/signingEngine/session/warmSigning/store.ts` | `../../session/persistence/records` |
| `client/src/core/signingEngine/session/warmSigning/types.ts` | `../../api/thresholdLifecycle/thresholdEcdsaBootstrapPersistence`<br>`../../session/persistence/records`<br>`../../emailOtp/authLane`<br>`../../orchestration/thresholdActivation`<br>`../../threshold/session/sessionPolicy` |
| `client/src/core/signingEngine/signers/algorithms/secp256k1.ts` | `../../orchestration/walletOrigin/thresholdEcdsaCoordinator`<br>`../../orchestration/walletOrigin/thresholdEcdsaCoordinator`<br>`../../session/signingSession/ecdsaChainTarget`<br>`../../threshold/session/sessionPolicy` |
...
| `client/src/core/signingEngine/threshold/session/sessionPolicy.ts` | `../../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/threshold/workflows/bootstrapEcdsaSession.ts` | `@/core/signingEngine/api/session/signingSessionState`<br>`../../signers/wasm/hssClientSignerWasm`<br>`../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/threshold/workflows/connectEcdsaSession.ts` | `../../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/threshold/workflows/keygenEcdsa.ts` | `../../session/signingSession/ecdsaChainTarget` |
| `client/src/core/signingEngine/touchConfirm/TouchConfirmManager.ts` | `../session/persistence/records`<br>`../threshold/session/sessionPolicy`<br>`../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/touchConfirm/handlers/flows/adapters/adapters.ts` | `@/core/signingEngine/signers/webauthn/credentials/collectAuthenticationCredentialForChallengeB64u`<br>`@/core/signingEngine/session/signingSession/types` |
...
| `client/src/core/signingEngine/touchConfirm/types.ts` | `../signers/webauthn/prompt/touchIdPrompt`<br>`../api/userPreferences`<br>`../session/signingSession/ecdsaChainTarget` |
...
| `client/src/core/signingEngine/workerManager/workerTypes.ts` | `../orchestration/thresholdActivation`<br>`../session/signingSession/ecdsaChainTarget`<br>`../threshold/session/sessionPolicy`<br>`../emailOtp/authLane` |
| `client/src/core/signingEngine/workerManager/workers/email-otp.worker.ts` | `@/core/signingEngine/orchestration/thresholdActivation`<br>`@/core/signingEngine/session/signingSession/ecdsaChainTarget`<br>`@/core/signingEngine/threshold/session/sessionPolicy`<br>`../../emailOtp/authLane`<br>`../../api/session/emailOtpDeviceEnrollmentEscrowStore` |
| `client/src/core/signingEngine/workerManager/workers/passkey-confirm.worker.ts` | `@/core/signingEngine/session/signingSession/ecdsaChainTarget`<br>`../../chainAdaptors/evm/bytes`<br>`../../touchConfirm/awaitUserConfirmation`<br>`../../touchConfirm/shared/confirmTypes` |
