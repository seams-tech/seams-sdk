...
- [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md)
- [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md)
- [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md)
- [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md)
...
Requirement: the spec keeps a hardening item to review and either remove client-supplied `group_public_key` or prove it is harmless through transcript binding and validation. See [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md:1581).
...
Requirement: the ECDSA plan says new Router A/B ECDSA protocol names should use `server` terminology and `*_server` variables until the ECDSA version freezes legacy names. See [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md:98).
...
1. Make [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md) the Ed25519 single-session/release-tail tracker.
2. Make [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md) the ECDSA-HSS release blocker tracker.
3. Treat [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md) and [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md) as historical specs plus status summaries, with links to the active trackers.
...
- ECDSA release-blocking scope: [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md:15)
- ECDSA normal-signing topology: [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md:27)
- ECDSA server-blindness: [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md:53)
- ECDSA public/private boundary: [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md:116)
- ECDSA one-use normal signing: [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md:136)
...
- Deployed evidence open: [docs/router-ab/protocol.md](/Users/pta/Dev/rust/seams-sdk/docs/router-ab/protocol.md:1478)
