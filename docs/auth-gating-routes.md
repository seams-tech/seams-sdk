...
| Console mutations with role gates       | onboarding create, project/environment mutation, members, approvals, policies, webhooks, API keys, runtime snapshots, key exports, billing writes and adjustments | `console`           | console session plus role requirements                                                | none     | correct                                                                              |
