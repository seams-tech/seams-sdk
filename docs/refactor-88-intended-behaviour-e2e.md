...
| `tests/unit/demoPasskeyEcdsaSignerOptions.unit.test.ts` | keep | Demo passkey registration option coverage. It verifies the demo enables Tempo and EVM ECDSA provisioning options outside the lifecycle contract matrix. |
