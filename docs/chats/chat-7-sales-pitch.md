...
- [docs/router-a-b-deployment-choices.md](../router-a-b-deployment-choices.md)
...
1. Turn [docs/router-a-b-deployment-choices.md](../router-a-b-deployment-choices.md) into an implementation checklist for generated Cloudflare same-account IaC.
