...
const allowedSignerRouterImports = buildAllowedImportSet([
  ...
  ['packages/sdk-server-ts/src/router/routerApi.ts', '../console/sponsorship/evmExecutorTypes'],
  ...
  ['packages/sdk-server-ts/src/router/routerApiSponsoredEvmCall.ts', '../console/sponsorship/evm'],
  ['packages/sdk-server-ts/src/router/routerApiSponsoredEvmCall.ts', '../console/sponsorship/evmExecutorTypes'],
  ['packages/sdk-server-ts/src/router/routerApiSponsoredEvmCall.ts', '../console/sponsorship/evmRoutes'],
  ['packages/sdk-server-ts/src/router/routerApiSponsoredEvmCall.ts', '../console/sponsorship/executionAdapter'],
  ['packages/sdk-server-ts/src/router/routerApiSponsoredEvmCall.ts', '../console/sponsorship/prepaidBalance'],
  ['packages/sdk-server-ts/src/router/routerApiSponsoredEvmCall.ts', '../console/sponsorship/spendCaps'],
  ...
  ['packages/sdk-server-ts/src/router/sponsorshipExecution.ts', '../console/sponsorship/prepaidBalance'],
  ['packages/sdk-server-ts/src/router/sponsorshipExecution.ts', '../console/sponsorship/spendCaps'],
  ...
  ['packages/sdk-server-ts/src/router/sponsorshipSpendCapObservability.ts', '../console/sponsorship/spendCaps'],
  ['packages/sdk-server-ts/src/router/routeDefinitions.ts', '../console/sponsorship/evmRoutes'],
