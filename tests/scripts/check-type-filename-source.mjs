...
const allowedTypesTsFiles = new Set([
  'packages/sdk-server-ts/src/console/account/types.ts',
  'packages/sdk-server-ts/src/console/apiKeys/types.ts',
  'packages/sdk-server-ts/src/console/approvals/types.ts',
  'packages/sdk-server-ts/src/console/audit/types.ts',
  'packages/sdk-server-ts/src/console/auditExports/types.ts',
  'packages/sdk-server-ts/src/console/billing/types.ts',
  'packages/sdk-server-ts/src/console/billingPrepaidReservations/types.ts',
  'packages/sdk-server-ts/src/console/bootstrapTokens/types.ts',
  'packages/sdk-server-ts/src/console/enterpriseIsolation/types.ts',
  'packages/sdk-server-ts/src/console/gasSponsorship/types.ts',
  'packages/sdk-server-ts/src/console/keyExports/types.ts',
  'packages/sdk-server-ts/src/console/observability/types.ts',
  'packages/sdk-server-ts/src/console/onboarding/types.ts',
  'packages/sdk-server-ts/src/console/orgProjectEnv/types.ts',
  'packages/sdk-server-ts/src/console/policies/types.ts',
  'packages/sdk-server-ts/src/console/runtimeSnapshots/types.ts',
  'packages/sdk-server-ts/src/console/sponsoredCalls/types.ts',
  'packages/sdk-server-ts/src/console/sponsorshipSpendCaps/types.ts',
  'packages/sdk-server-ts/src/console/teamRbac/types.ts',
  'packages/sdk-server-ts/src/console/wallets/types.ts',
  'packages/sdk-server-ts/src/console/webhooks/types.ts',
