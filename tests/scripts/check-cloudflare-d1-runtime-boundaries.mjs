...
const d1LocalBackupRestoreDrillScript =
  'packages/console-server-ts/scripts/d1-local-backup-restore-drill.mjs';
...
const d1StagingCliHelperScripts = listJavaScriptFiles('packages/console-server-ts/scripts').filter(
  (relativePath) =>
