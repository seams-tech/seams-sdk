...
import { readAvailableSigningLanes } from '@/core/signingEngine/session/availability/availableSigningLanes';
...
import { buildExactPasskeyOwnerLaneScope } from '@/core/signingEngine/session/identity/ownerLaneScope';
