  ...
  const walletKeys = [
    {
      ...
      keyHandle: 'ederivation-key-ethereum',
      ecdsaThresholdKeyId: 'ederivation-key-id-ethereum',
    ...
    },
    {
      ...
      keyHandle: 'ederivation-key-tempo',
      ecdsaThresholdKeyId: 'ederivation-key-id-tempo',
      signingRootId: 'project_registration:dev',
      signingRootVersion: 'root_v1',
  ...
  const walletKeys = [
    {
      ...
      keyHandle: 'ederivation-key-email-ethereum',
      ecdsaThresholdKeyId: 'ederivation-key-id-email-ethereum',
      signingRootId: 'project_registration:dev',
      signingRootVersion: 'root_v1',
    ...
    },
    {
      ...
      walletId: 'wallet_email_mixed',
      evmFamilySigningKeySlotId: 'evm-family-slot-email-mixed',
      keyHandle: 'ederivation-key-email-tempo',
      ecdsaThresholdKeyId: 'ederivation-key-id-email-tempo',
      signingRootId: 'project_registration:dev',
      signingRootVersion: 'root_v1',
...
test('wallet add-signer persists Ed25519 signer records without re-registering authenticator', async () => {
  ...
  const result = await finalizeWalletEd25519SignerRegistration(deps as any, {
    ...
    auth: { kind: 'passkey', credential: authenticationCredential },
    signerSlot: 3,
    operationalPublicKey: 'ed25519:public',
    relayerKeyId: 'relayer-key',
    keyVersion: 'router-ab-ed25519-yao-v1',
  ...
  const walletKeys = [
    {
      ...
      ecdsaThresholdKeyId: 'ederivation-key-id-matrix',
      signingRootId: 'project_registration:dev',
      signingRootVersion: 'root_v1',
      thresholdEcdsaPublicKeyB64u: 'A1111111111111111111111111111111111111111111',
      thresholdOwnerAddress: '0x1111111111111111111111111111111111111111',
