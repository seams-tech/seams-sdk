...
pub use circuit::{
    ...
    LaneMaterializationCoreV1, LaneMaterializationInputErrorV1,
    LaneMaterializationScheduleDigest32V1, Phase4PrivateOutputActivationCoreDigest32V1,
    Phase4PrivateOutputActivationCoreV1, Phase4PrivateOutputActivationScheduleDigest32V1,
    Phase4PrivateOutputExportCoreDigest32V1, Phase4PrivateOutputExportCoreV1,
    Phase4PrivateOutputExportScheduleDigest32V1, ProvisionalActivationCoreDigest32V1,
    ProvisionalActivationCoreV1, ProvisionalActivationScheduleDigest32V1,
    ProvisionalBenchmarkComponentDigest32V1, ProvisionalBenchmarkScheduleDigest32V1,
    ProvisionalExportCoreDigest32V1, ProvisionalExportCoreV1, ProvisionalExportScheduleDigest32V1,
    ProvisionalScheduleMetricsV1, PublicSyntheticActivationCoreInputsV1,
    PublicSyntheticActivationCoreOutputsV1, PublicSyntheticActivationInputErrorV1,
    ...
    PublicSyntheticExportCoreInputsV1, PublicSyntheticExportCoreOutputV1,
