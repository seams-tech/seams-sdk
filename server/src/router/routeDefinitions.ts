...
export function createRelayRouteDefinitions(
  ...
  definitions.push(
    ...
    userSessionRoute(
      'wallet_email_otp_enroll_challenge',
      'POST',
      '/wallet/email-otp/enroll/challenge',
      'Create Email OTP enrollment challenge for the current app session',
      ['authService', 'session'],
    ),
    userSessionRoute(
      'wallet_email_otp_enroll_seal',
      'POST',
      '/wallet/email-otp/enroll/seal',
      'Apply the Email OTP server seal for a new enrollment blob',
      ['authService', 'session'],
    ),
    userSessionRoute(
      'wallet_email_otp_enroll_verify',
      'POST',
      '/wallet/email-otp/enroll/verify',
      'Verify Email OTP enrollment challenge for the current app session',
      ['authService', 'session'],
    ),
    userSessionRoute(
      ...
      'Create Email OTP challenge for the current app session',
      ['authService', 'session'],
    ),
    userSessionRoute(
      'wallet_email_otp_verify',
      'POST',
      '/wallet/email-otp/verify',
      'Verify Email OTP challenge for the current app session',
      ['authService', 'session'],
    ),
    userSessionRoute(
