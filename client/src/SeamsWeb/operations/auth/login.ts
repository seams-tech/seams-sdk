...
import { prewarmThresholdEd25519ClientBaseFromCredential } from '@/SeamsWeb/operations/session/thresholdWarmSessionBootstrap';
...
export async function lock(context: LockWebContext): Promise<void> {
  ...
  try {
    await emailOtpRecoveryCodeBackupRepository.clearAll();
  } catch {}
  try {
    clearAllStoredThresholdEd25519SessionRecords();
  } catch {}
