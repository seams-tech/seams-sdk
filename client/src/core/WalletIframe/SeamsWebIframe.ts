...
import type { SignNEP413MessageParams, SignNEP413MessageResult } from '@/web/SeamsWeb/near';
...
import { executeEvmFamilyTransactionLifecycle } from '@/web/SeamsWeb/tempo/executeEvmFamilyTransaction';
import { toAccountId } from '@/core/types/accountIds';
import { walletIdFromString } from '@shared/utils/registrationIntent';
import { buildPasskeyNearWalletRegistrationSignerSelection } from '@/web/SeamsWeb/registrationSignerSelection';
...
export class SeamsWebIframe {
  ...
  private async sendDelegateActionViaRelayerDomain(args: {
    ...
    const { sendDelegateActionViaRelayer } = await import('@/web/SeamsWeb/near');
   ...
   * the host-side SeamsWeb. Routes to the wallet iframe router when ready.
   */
  ...
  getConfirmationConfig(): ConfirmationConfig {
    // Synchronous API parity with SeamsWeb
