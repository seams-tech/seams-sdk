...
- `client/src/core/signingEngine/secureConfirm/ui/lit-components/css/css-loader.ts`
...
- Verify changes to `client/src/core/signingEngine/secureConfirm/ui/lit-components/css/w3a-components.css` and commit.
