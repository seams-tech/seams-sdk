...
- File: `client/src/core/signingEngine/secureConfirm/ui/confirm-ui.ts`
- Element contract: `client/src/core/signingEngine/secureConfirm/ui/confirm-ui-types.ts`
...
```ts
// client/src/core/signingEngine/secureConfirm/ui/ensure-defined.ts
