...
import type { ThresholdEcdsaSmartAccountBootstrapInput } from '@/core/signingEngine/session/warmSigning/ecdsaBootstrapPersistence';
...
export class EmailOtpThresholdSessionCoordinator {
  ...
  private ecdsaBootstrapWithWalletSigningSessionId(args: {
    bootstrap: ThresholdEcdsaSessionBootstrapResult;
    walletSigningSessionId: string;
  }): ThresholdEcdsaSessionBootstrapResult {
    const walletSigningSessionId = this.walletSigningSessionIdFromEcdsaBootstrap(
      args.bootstrap,
