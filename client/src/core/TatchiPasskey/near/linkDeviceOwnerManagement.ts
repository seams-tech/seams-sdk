...
import {
  ...
  TATCHI_SMART_ACCOUNT_REMOVE_OWNER_ABI,
} from '@shared/utils/evmSmartAccountSpec';

const ADD_OWNER_SELECTOR = getTatchiSmartAccountMethodSelector('addOwner');
const REMOVE_OWNER_SELECTOR = getTatchiSmartAccountMethodSelector('removeOwner');
const ADD_OWNER_ABI = TATCHI_SMART_ACCOUNT_ADD_OWNER_ABI as EvmContractAbi;
const REMOVE_OWNER_ABI = TATCHI_SMART_ACCOUNT_REMOVE_OWNER_ABI as EvmContractAbi;
