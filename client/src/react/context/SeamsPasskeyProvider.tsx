...
export type SeamsPasskeyProviderThemeProps = Omit<ThemeProps, 'children'> & {
  setTheme?: (theme: ThemeName) => void;
};

export interface SeamsPasskeyProviderProps {
   ...
   */
  theme?: SeamsPasskeyProviderThemeProps;
  /**
...
function resolveConfigTokenOverrides(
  config: SeamsPasskeyProviderProps['config'],
...
/**
 * SeamsPasskeyProvider — ergonomic composition of Theme + PasskeyProvider.
 * Renders a theming boundary (Theme) and provides Passkey context.
 */
export const SeamsPasskeyProvider: React.FC<SeamsPasskeyProviderProps> = ({
  config,
  theme,
  walletOverlayZIndex,
  eager,
  ...
  const providerConfig = React.useMemo<SeamsPasskeyProviderProps['config']>(() => {
...
export default SeamsPasskeyProvider;
