...
import type { SignNEP413MessageParams, SignNEP413MessageResult } from '@/web/SeamsWeb/operations/near/signNEP413';
import type { SyncAccountResult } from '@/web/SeamsWeb/operations/recovery/syncAccount';
...
export type NearSigningSurface = Pick<
  SeamsWebSigningSurface,
  'getNonceCoordinator' | 'signNear' | 'signTransactionWithKeyPair' | 'generateEphemeralNearKeypair'
>;

export type EvmFamilySigningSurface = Pick<SeamsWebSigningSurface, 'signEvmFamily'>;

export type TempoNonceLifecycleSurface = Pick<
  SeamsWebSigningSurface,
...
export type EcdsaSessionBootstrapSurface = Pick<SeamsWebSigningSurface, 'bootstrapEcdsaSession'>;

export type TempoSigningSurface = EvmFamilySigningSurface &
  TempoNonceLifecycleSurface &
  EcdsaSessionBootstrapSurface;

export type WalletIframeWarmupSurface = Pick<SeamsWebSigningSurface, 'warmCriticalResources'>;
...
export type EcdsaLoginSessionSurface = Pick<
  SeamsWebSigningSurface,
  'listThresholdEcdsaSessionRecordsForWalletTarget' | 'scheduleThresholdEcdsaLoginPresignPrefill'
>;

export type LoginWarmSigningSurface = Pick<
  SeamsWebSigningSurface,
...
export type RegistrationAccountSurface = Pick<
  SeamsWebSigningSurface,
...
export type EcdsaRegistrationSurface = Pick<
  SeamsWebSigningSurface,
  | 'preparePasskeyEcdsaBootstrap'
  | 'prepareEmailOtpEcdsaBootstrap'
  | 'finalizeWalletRegistrationEcdsaSessions'
...
export type SigningSessionSurface = Pick<
  SeamsWebSigningSurface,
...
export type WalletSessionReadSurface = Pick<
  SeamsWebSigningSurface,
  | 'assertSealedRefreshStartupParity'
  | 'getNonceCoordinator'
  | 'getLastUser'
...
export type LockSigningSurface = Pick<
  SeamsWebSigningSurface,
  | 'getNonceCoordinator'
...
export type AccountSyncSigningSurface = LocalLoginStateSurface &
  ...
  Pick<
    SeamsWebSigningSurface,
    'getRpId' | 'getAuthenticationCredentialsSerialized' | 'storeUserData' | 'storeAuthenticator'
  >;

export type WebAuthnRegistrationConfirmationSurface = Pick<
  SeamsWebSigningSurface,
  'requestRegistrationCredentialConfirmation'
>;

export type ThresholdEd25519HssClientSurface = Pick<
  SeamsWebSigningSurface,
  | 'prepareThresholdEd25519HssClientCeremonyFromCredential'
  | 'prepareThresholdEd25519HssClientCeremonyFromPrfFirst'
  | 'prepareThresholdEd25519HssClientRequest'
...
export type RegistrationSigningSurface = Pick<
  SeamsWebSigningSurface,
  | 'getRpId'
  | 'readPersistedAvailableSigningLanes'
  | 'prepareEmailOtpRegistrationEnrollmentMaterialInternal'
...
export type RegistrationWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: RegistrationSigningSurface;
};

export type NearSigningWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: NearSigningSurface &
    UserAccountLookupSurface &
    Pick<RegistrationSigningSurface, 'getRpId'>;
};

export type WalletSessionWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: WalletSessionReadSurface;
};

export type LoginWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: LoginUnlockSigningSurface;
};

export type LockWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: LockSigningSurface;
};

export type RecentUnlocksWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: RecentUnlocksSigningSurface;
};

export type AuthSessionWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: LoginUnlockSigningSurface &
    LockSigningSurface &
...
export type LocalLoginStateWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: LocalLoginStateSurface;
};

export type AccountSyncWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: AccountSyncSigningSurface;
};
...
export type EmailRecoveryWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: EmailRecoverySigningSurface;
};
...
export type DeviceLinkingWebContext = Omit<SeamsWebContext, 'signingEngine'> & {
  signingEngine: DeviceLinkingSigningSurface;
};
