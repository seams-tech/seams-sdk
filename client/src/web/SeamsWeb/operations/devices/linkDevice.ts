...
import { restoreLocalLoginState } from '@/web/SeamsWeb/operations/session/restoreLocalLoginState';
import { linkDeviceWithScannedQRData as linkDeviceWithScannedQRDataDevice1 } from '@/web/SeamsWeb/operations/devices/scanDevice';
...
import { passkeyPrfFirstB64uFromCredential } from '@/web/SeamsWeb/operations/authMethods/passkey/ecdsaBootstrap';
...
export class LinkDeviceFlow {
  private context: DeviceLinkingWebContext;
  ...
  constructor(context: DeviceLinkingWebContext, options: StartDevice2LinkingFlowArgs) {
