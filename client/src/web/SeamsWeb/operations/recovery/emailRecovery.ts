...
import { syncAccount as syncAccountCore, type SyncAccountResult } from '@/web/SeamsWeb/operations/recovery/syncAccount';
import type { EmailRecoveryWebContext } from '@/web/SeamsWeb/signingSurface/types';
