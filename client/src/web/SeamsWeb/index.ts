import { BrowserSigningSurface } from '@/web/SeamsWeb/assembly/BrowserSigningSurface';
import {
...
import { ConfirmationConfig, type ConfirmationBehavior } from '@/core/types/signer-worker';
...
export class SeamsWeb {
  ...
  getContext(): SeamsWebContext {
    return {
      signingEngine: this.signingEngine,
      signingRuntime: this.signingEngine.signingRuntime,
  ...
  async loginWithEmailOtpEcdsaCapability(
    ...
    try {
      ...
      await this.signingEngine.signingRuntime.services.registrationAccounts
