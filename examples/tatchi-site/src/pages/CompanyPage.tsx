...
export function CompanyPage(): React.JSX.Element {
  ...
  return (
    ...
    >
      ...
      <article className="site-card">
        <h2>Open Source</h2>
        <p><a href="https://github.com/web3-authn/tatchi" target="_blank" rel="noopener noreferrer">GitHub Repository</a></p>
      </article>
      <article className="site-card">
        <h2>Get Started</h2>
        <ul className="site-links-list">
          <li><a href={installationProps.href} onClick={installationProps.onClick}>Installation</a></li>
