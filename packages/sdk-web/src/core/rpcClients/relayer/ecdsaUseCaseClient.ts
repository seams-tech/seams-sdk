...
function parseBootstrapOutput(
  ...
  if (
    ...
    !sameString(value.signingRootId, input.signingRootId) ||
    !sameString(value.signingRootVersion, input.signingRootVersion) ||
  ...
  return {
    ...
    thresholdSessionAuthToken: String(value.jwt || '').trim(),
  };
}
