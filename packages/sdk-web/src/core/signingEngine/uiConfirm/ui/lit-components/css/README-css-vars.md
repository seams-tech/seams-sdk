...
- Generator: `node packages/sdk-web/scripts/codegen/generate-w3a-components-css.mjs`
...
- Check `packages/sdk-web/scripts/codegen/generate-w3a-components-css.mjs` and `client/src/theme/base-styles.js` for the current mapping and output shape.
