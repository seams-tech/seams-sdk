...
import { ITatchiSmartAccount, SmartAccountInit } from "./interfaces/ITatchiSmartAccount.sol";
import { PackedUserOperation } from "./interfaces/IAccount.sol";
import { ECDSA } from "./utils/ECDSA.sol";

contract TatchiSmartAccount is ITatchiSmartAccount {
  ...
  bytes32 internal constant RECOVERY_NAME_HASH = keccak256("TatchiSmartAccountRecovery");
