...
import { TatchiSmartAccountFactory } from "../src/TatchiSmartAccountFactory.sol";
import { TestBase } from "./TestBase.sol";

contract TatchiSmartAccountFactoryTest is TestBase {
  ...
  TatchiSmartAccountFactory private factory;
  ...
  function setUp() public {
    factory = new TatchiSmartAccountFactory();
  ...
  function testCreateAccountMatchesPredictedAddressAndInitializesState() public {
    ...
    TatchiSmartAccount account = TatchiSmartAccount(payable(deployed));
