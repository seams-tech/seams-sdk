...
```bash
cargo run --release --manifest-path crates/succinct-garbling/Cargo.toml --bin benchmark_prime_order_cpu_executor -- --json --output crates/succinct-garbling/reports/phase1/native-desktop-release.json
