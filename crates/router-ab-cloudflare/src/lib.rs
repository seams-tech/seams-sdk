...
use paths::{
    ...
    cloudflare_ecdsa_hss_deriver_recovery_service_url_v1,
    cloudflare_ecdsa_hss_deriver_refresh_service_url_v1,
    cloudflare_ecdsa_hss_deriver_registration_service_url_v1,
    cloudflare_ecdsa_hss_signing_worker_activation_refresh_service_url_v1,
    cloudflare_ecdsa_hss_signing_worker_activation_service_url_v1,
    cloudflare_signer_peer_service_url_v1, cloudflare_signer_service_url_v1,
    cloudflare_signing_worker_ecdsa_hss_evm_digest_finalize_service_url_v1,
    cloudflare_signing_worker_ecdsa_hss_evm_digest_prepare_service_url_v1,
    cloudflare_signing_worker_normal_signing_presign_pool_prepare_service_url_v1,
    cloudflare_signing_worker_normal_signing_presign_pool_service_url_v1,
    cloudflare_signing_worker_normal_signing_round1_prepare_service_url_v1,
    cloudflare_signing_worker_normal_signing_service_url_v1,
    cloudflare_signing_worker_recipient_proof_bundle_activation_service_url_v1,
};
#[cfg(any(
    all(
