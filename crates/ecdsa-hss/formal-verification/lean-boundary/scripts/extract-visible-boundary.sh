...
(
  ...
  "${CHARON_BIN}" cargo \
    --preset aeneas \
    --start-from ecdsa_hss::server::boundary::visible_boundary_from_respond_response \
    --start-from ecdsa_hss::server::boundary::hidden_eval_input_boundary_from_staged_request \
    --start-from ecdsa_hss::server::boundary::hidden_eval_transport_boundary_from_respond_response \
    --start-from ecdsa_hss::server::boundary::hidden_eval_persisted_state_boundary_from_finalized_session \
    --start-from ecdsa_hss::server::boundary::hidden_eval_boundary_from_parts \
    --dest-file "${LLBC_FILE}" \
    -- --lib
)
