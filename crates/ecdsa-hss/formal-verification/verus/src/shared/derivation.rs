...
pub uninterp spec fn candidate_client_share_v1_spec(
    x_be_bytes: Bytes32,
    context: CanonicalContextV1,
    retry_counter: u32,
) -> Bytes32;

pub uninterp spec fn relayer_share_from_x_and_client_share_v1_spec(
    x_be_bytes: Bytes32,
...
pub broadcast axiom fn axiom_retry_counter_selects_valid_distinct_client_share_v1(
    x_be_bytes: Bytes32,
    context: CanonicalContextV1,
)
    requires
    ...
    ensures
        ...
        is_valid_nonzero_scalar_v1_spec(candidate_client_share_v1_spec(
            x_be_bytes,
            context,
            retry_counter_v1_spec(x_be_bytes, context),
        )),
        candidate_client_share_v1_spec(
            x_be_bytes,
            context,
            retry_counter_v1_spec(x_be_bytes, context),
        ) != x_be_bytes,
...
pub broadcast axiom fn axiom_relayer_share_is_valid_and_reconstructs_x_v1(
    x_be_bytes: Bytes32,
    x_client_be_bytes: Bytes32,
)
    requires
    ...
    ensures
        #![trigger relayer_share_from_x_and_client_share_v1_spec(x_be_bytes, x_client_be_bytes)]
        is_valid_nonzero_scalar_v1_spec(relayer_share_from_x_and_client_share_v1_spec(
            x_be_bytes,
            x_client_be_bytes,
        )),
        (
            bytes32_as_int_v1_spec(x_client_be_bytes)
                + bytes32_as_int_v1_spec(relayer_share_from_x_and_client_share_v1_spec(
                    x_be_bytes,
                    x_client_be_bytes,
                ))
...
pub proof fn additive_share_outputs_are_valid_nonzero_scalars(
    ...
    ensures
        additive_shares_are_in_scalar_domain_v1_spec(x_be_bytes, context),
{
    broadcast use axiom_retry_counter_selects_valid_distinct_client_share_v1;
    broadcast use axiom_relayer_share_is_valid_and_reconstructs_x_v1;
}
