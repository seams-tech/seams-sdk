...
| OL-PERSIST-01 | Reserve, commit, consumption, and destruction survive crashes and ambiguous delivery. | `../router-ab-ecdsa-pool/src/lib.rs:218-465`; `packages/sdk-web/src/core/signingEngine/workerManager/opaqueEcdsaPresignAuthority.ts`; `crates/router-ab-cloudflare/src/ecdsa_pool_lifecycle.rs` | Full local integration | 0.99 |
