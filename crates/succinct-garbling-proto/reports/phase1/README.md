...
```bash
cargo run --release --manifest-path crates/succinct-garbling-proto/Cargo.toml --bin benchmark_prime_order_cpu_executor -- --json --output crates/succinct-garbling-proto/reports/phase1/native-desktop-release.json
