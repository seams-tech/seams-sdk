...
#[wasm_bindgen]
pub fn threshold_ecdsa_derivation_role_local_finalize_client_bootstrap(
    args: JsValue,
) -> Result<JsValue, JsValue> {
    let pending_state_blob =
        signer_core::ecdsa_role_local_client::command::EcdsaRoleLocalPendingStateBlob {
    ...
    set_string(
        ...
        &base64_url_encode(&finalized.public_facts.derivation_client_share_public_key33),
    )?;
    set_string(
        &out,
