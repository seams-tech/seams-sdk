...
pub fn sign_secp256k1_recoverable(
    ...
    let result = signer_platform_web::secp256k1::sign_secp256k1_recoverable(
        digest32.as_slice(),
...
pub fn verify_secp256k1_recoverable_signature_against_public_key_33(
    ...
    let result =
        signer_platform_web::secp256k1::verify_secp256k1_recoverable_signature_against_public_key_33(
        digest32.as_slice(),
