...
pub fn threshold_ecdsa_compute_signature_share(
    ...
    let result = signer_core::threshold_ecdsa::threshold_ecdsa_compute_signature_share(
        participant_ids.as_slice(),
        me,
        public_key_sec1.as_slice(),
...
pub fn threshold_ecdsa_finalize_signature(
    ...
    let result = signer_core::threshold_ecdsa::threshold_ecdsa_finalize_signature(
        participant_ids.as_slice(),
        relayer_id,
        public_key_sec1.as_slice(),
        presign_big_r_sec1.as_slice(),
