...
pub fn derive_secp256k1_keypair_from_prf_second(
    ...
    let result = signer_platform_web::secp256k1::derive_secp256k1_keypair_from_prf_second(
        prf_second.as_slice(),
...
pub fn secp256k1_private_key_32_to_public_key_33(
    ...
    let result = signer_platform_web::secp256k1::secp256k1_private_key_32_to_public_key_33(
