...
const emitWalletServiceStaticAssets = async (sdkRoot = process.cwd()): Promise<void> => {
  ...
  copyIfMissing(
    path.join(sdkRoot, '../client/src/SeamsWeb/walletIframe/client/overlay/overlay.css'),
...
const configs = [
  ...
  // Wallet iframe host + confirmer bundles
  {
    input: {
      ...
      'wallet-iframe-host-runtime': '../client/src/SeamsWeb/walletIframe/host/index.ts',
      'wallet-iframe-host-near': '../client/src/SeamsWeb/walletIframe/host/entry-near.ts',
      'wallet-iframe-host-ecdsa': '../client/src/SeamsWeb/walletIframe/host/entry-ecdsa.ts',
      'wallet-iframe-host-full': '../client/src/SeamsWeb/walletIframe/host/entry-full.ts',
